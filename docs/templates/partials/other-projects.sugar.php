...
<div class="mt-6 pt-4 border-t border-base-300/80">
	...
	<div class="space-y-2">
		<a
			...
			href="https://josbeir.github.io/sugar/?utm_source=glaze-docs&utm_medium=referral&utm_campaign=other-projects"
			target="_blank"
			rel="noopener noreferrer"
			aria-label="Open Sugar website"
		>
			<img class="h-6 w-6 shrink-0" src="<?= $this->url('/sugar-cube-static.svg') ?>" alt="Sugar logo" />
			<span class="min-w-0">
				<span class="block text-sm font-medium leading-tight">Sugar</span>
				<span class="block text-xs text-base-content/65 truncate">PHP template engine</span>
			</span>
		</a>

		<a
			class="flex items-center gap-2 rounded-box border border-base-300 bg-base-100 px-2.5 py-2 hover:border-primary/40 hover:bg-base-100/80 transition-colors"
			href="https://www.jaspersmet.be/?utm_source=glaze-docs&utm_medium=referral&utm_campaign=other-projects"
			target="_blank"
			rel="noopener noreferrer"
		...
		>
			...
			<span class="min-w-0">
				...
				<span class="block text-xs text-base-content/65 truncate">Creator of Glaze</span>
			</span>
		</a>
	</div>
</div>
