...
<s-template s:block="sidebar"></s-template>

<s-template s:block="content">
	<section class="border-base-300 mb-10 sm:mb-12">
		<div class="grid gap-10 lg:gap-14 lg:grid-cols-[minmax(0,1fr)_24rem] xl:grid-cols-[minmax(0,1fr)_28rem] lg:items-center">
			<div>
				<div class="badge badge-primary badge-outline mb-4">Documentation</div>
				<h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-5"><?= $page->meta('meta.hero.title', $title) ?></h1>
				<p class="text-base-content/75 text-lg lg:text-xl max-w-3xl" s:if="$page->hasMeta('meta.hero.subtitle')">
					<?= $page->meta('meta.hero.subtitle') ?>
				</p>

				<div class="flex flex-wrap gap-4 mt-8">
					<a
						class="btn btn-primary btn-md"
						s:if="$page->hasMeta('meta.hero.primaryAction.label')"
						href="<?= ($site->basePath ?? '') . $page->meta('meta.hero.primaryAction.href', '/') ?>"
					>
						<?= $page->meta('meta.hero.primaryAction.label') ?>
					</a>

					<a
						class="btn btn-ghost btn-md"
						s:if="$page->hasMeta('meta.hero.secondaryAction.label')"
						href="<?= ($site->basePath ?? '') . $page->meta('meta.hero.secondaryAction.href', '/') ?>"
					>
						<?= $page->meta('meta.hero.secondaryAction.label') ?>
					</a>
				</div>
			</div>
		...
		<div class="grid gap-4 mt-12 sm:grid-cols-2 lg:grid-cols-3" s:if="$page->hasMeta('meta.hero.highlights')">
			<s-template s:foreach="$page->meta('meta.hero.highlights', []) as $heroHighlight">
			<div class="card bg-base-200 border border-base-300">
				<div class="card-body p-5">
					...
					?>
					<div class="mb-2" s:notempty="$highlightIcon"><?= $highlightIcon |> raw() ?></div>
		...
		<div class="card bg-base-200 border border-base-300 mt-12" data-scaffold-demo>
			<div class="card-body gap-6 p-5 sm:p-6 lg:p-7">
				...
				<div class="grid gap-5 lg:grid-cols-[minmax(0,1fr)_20rem]">
					<div class="mockup-code bg-neutral text-neutral-content shadow-inner">
					...
					<div class="rounded-box border border-base-300 bg-base-100 p-4">
						...
						<ul class="menu menu-sm gap-1 w-full" data-scaffold-steps>
							<li class="scaffold-step" data-scaffold-step="0"><span>content/index.dj</span></li>
							<li class="scaffold-step" data-scaffold-step="1"><span>templates/page.sugar.php</span></li>
							<li class="scaffold-step" data-scaffold-step="2"><span>templates/layout/page.sugar.php</span></li>
							<li class="scaffold-step" data-scaffold-step="4"><span>glaze.neon</span></li>
							<li class="scaffold-step" data-scaffold-step="5"><span>vite.config.js</span></li>
							<li class="scaffold-step" data-scaffold-step="6"><span>package.json</span></li>
						</ul>
					</div>
				</div>
			</div>
